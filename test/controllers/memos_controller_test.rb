...
class MemosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create memo" do
    assert_difference('Memo.count') do
      post memos_url, params: { memo: { access_at: @memo.access_at, access_cnt: @memo.access_cnt, text: @memo.text, title: @memo.title } }
    end
  ...
  test "should update memo" do
    patch memo_url(@memo), params: { memo: { access_at: @memo.access_at, access_cnt: @memo.access_cnt, text: @memo.text, title: @memo.title } }
